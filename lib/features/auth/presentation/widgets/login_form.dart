  ...
  void _handleLogin() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      if (authState is AuthAuthenticated) {
        final sharePreferenceManager = await ref.read(
          preferenceManagerSingleValuePareProvider,
        );
        ...
        sharePreferenceManager.setString(
          ...
          authState.user.userPhoneNumber,
        );
        sharePreferenceManager.setString(
          StorageConstants.tokenExpiry,
          authState.user.userExpireToken,
        );
        sharePreferenceManager.setString(
          StorageConstants.refreshToken,
          authState.user.userRefreshToken,
        );
      }
    }
  }

  final GlobalKey<TextFieldCustomState> _emailFieldKey =
